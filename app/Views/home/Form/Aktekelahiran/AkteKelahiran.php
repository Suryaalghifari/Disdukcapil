...
<main class="main-content">
    <div class="container">
        <div class="form-header">
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1>Pengajuan Akte Kelahiran</h1>
                    <p>Lengkapi formulir berikut untuk mengajukan pembuatan Akte Kelahiran</p>
                </div>
            </div>
            <!-- Progress Steps -->
            <div class="progress-steps">
                <div class="step active" data-step="1"><div class="step-number">1</div><div class="step-label">Data Anak & Orang Tua</div></div>
        ...
        <div class="form-container">
            ...
            <form id="akte-form" class="multi-step-form" enctype="multipart/form-data" autocomplete="off">
                <!-- STEP 1: Data Anak & Orang Tua -->
                <div class="form-step active" id="step-1">
                    <div class="step-content">
                        <h2 class="step-title"><i class="fas fa-user"></i> Data Anak & Orang Tua</h2>
                        <div class="form-grid">
                            <div class="form-group">
                                <label for="nama-lengkap" class="form-label">Nama Lengkap Anak <span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="nama-ayah" class="form-label">Nama Ayah <span class="required">*</span></label>
                                <input type="text" id="nama-ayah" name="nama_ayah" class="form-input" required>
                            </div>
                            <div class="form-group">
                                <label for="nik-ayah" class="form-label">NIK Ayah</label>
                                <input type="text" id="nik-ayah" name="nik_ayah" class="form-input">
                            </div>
                            <div class="form-group">
                                <label for="nama-ibu" class="form-label">Nama Ibu <span class="required">*</span></label>
                                <input type="text" id="nama-ibu" name="nama_ibu" class="form-input" required>
                            </div>
                            <div class="form-group">
                                <label for="nik-ibu" class="form-label">NIK Ibu</label>
                                <input type="text" id="nik-ibu" name="nik_ibu" class="form-input">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="tempat-perkawinan" class="form-label">Tempat Perkawinan</label>
                                <input type="text" id="tempat-perkawinan" name="tempat_perkawinan" class="form-input">
                            </div>
                            <div class="form-group">
                                <label for="tanggal-perkawinan" class="form-label">Tanggal Perkawinan</label>
                                <input type="date" id="tanggal-perkawinan" name="tanggal_perkawinan" class="form-input">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="upload-section">
                            <div class="upload-info">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-check"></i> Surat Kelahiran (file_surat_lahir) - PDF/JPG, Max 2MB</li>
                                    <li><i class="fas fa-check"></i> KTP Orang Tua (file_ktp_ortu) - PDF/JPG, Max 2MB</li>
                                </ul>
                            </div>
                            ...
                            <div class="upload-item">
                                <div class="upload-box" data-upload="file_surat_lahir" style="cursor:pointer;">
                                    ...
                                    <input type="file" id="file-surat-lahir" name="file_surat_lahir" accept=".pdf,.jpg,.jpeg" hidden required>
                                    <span class="file-name"></span>
                                </div>
                            </div>
                            <div class="upload-item">
                ...
                <div class="form-step" id="step-4">
                    <div class="step-content">
                        <div class="success-content">
                            ...
                            <p>Terima kasih telah mengajukan pembuatan Akte Kelahiran. Berikut detail pengajuan Anda:</p>
...
function validateCurrentStep() {
    ...
    if (currentStep === 2) {
        let uploads = [
            ...
            {id: 'file-surat-lahir', label: 'Surat Kelahiran'},
...
document.getElementById('akte-form').onsubmit = function(e) {
    e.preventDefault();
...
// Submit AJAX
function submitAkteAjax() {
    let form = document.getElementById('akte-form');
    ...
    fetch('<?= base_url('form/aktekelahiran/ajax') ?>', {
        method: 'POST',
        body: formData
    })
    .then(res => res.json())
    .then(res => {
        ...
        if (res.status === 'success') {
            ...
            setTimeout(() => window.location.href = '<?= base_url('form/aktekelahiran/riwayat') ?>', 2000);
        } else {
            let err = res.message;
            if (res.errors)
