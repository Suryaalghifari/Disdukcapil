...
<section class="services" id="history">
    <div class="container">
        <div class="section-header fade-in visible">
            <h2 class="section-title">Riwayat Pengajuan Akte Kematian</h2>
            <p class="section-subtitle">
                Lihat semua pengajuan Akte Kematian Anda.<br>
        ...
        <div class="services-grid">
            <?php if (empty($riwayat)): ?>
                <div class="service-card fade-in visible" style="text-align:center;">
                    <span>Belum ada riwayat pengajuan akte kematian.</span>
                </div>
            <?php else: ?>
                    ...
                    <div class="service-card fade-in visible">
                        <div style="margin-bottom: 12px;">
                            <div style="font-weight: 600; font-size: 1rem; color: #e11d48;">
                                <?= esc($pengajuan['nama_meninggal']) ?>
                            </div>
                            <?php if (!empty($pengajuan['nik_meninggal'])): ?>
                                <div style="font-size: 0.95rem; color: #777;">
                                    NIK: <?= esc($pengajuan['nik_meninggal']) ?>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if (!empty($pengajuan['file_pdf'])): ?>
                            <a href="<?= site_url('form/aktekematian/download/' . $pengajuan['id']) ?>"
