...
<main class="main-content">
    <div class="container">
        <div class="form-header">
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1>Pengajuan Akte Perceraian</h1>
                    <p>Lengkapi formulir berikut untuk mengajukan pembuatan Akte Perceraian.</p>
                </div>
            </div>
            <div class="progress-steps">
                ...
                <div class="step" data-step="4"><div class="step-number">4</div><div class="step-label">Data Perceraian</div></div>
        ...
        <div class="form-container">
            ...
            <form id="perceraian-form" class="multi-step-form" enctype="multipart/form-data" autocomplete="off">
                <!-- STEP 1: Data Suami -->
                ...
                <div class="form-step" id="step-3">
                    <div class="step-content">
                        <h2 class="step-title"><i class="fas fa-heart"></i> Data Perkawinan</h2>
                        <div class="form-grid">
                            <div class="form-group">
                                <label>Nomor Akte Perkawinan <span class="required">*</span></label>
                                <input type="text" name="nomor_perkawinan" class="form-input" required>
                            </div>
                            <div class="form-group">
                ...
                <!-- STEP 4: Data Perceraian -->
                <div class="form-step" id="step-4">
                    <div class="step-content">
                        <h2 class="step-title"><i class="fas fa-user-times"></i> Data Perceraian</h2>
                        <div class="form-grid">
                            <div class="form-group">
                                <label>Tanggal Perceraian <span class="required">*</span></label>
                                <input type="date" name="tanggal_perceraian" class="form-input" required>
                            </div>
                            <div class="form-group">
                                <label>Tempat Perceraian <span class="required">*</span></label>
                                <input type="text" name="tempat_perceraian" class="form-input" required>
                            </div>
                            <div class="form-group full-width">
                                <label>Penyebab Perceraian <span class="required">*</span></label>
                                <textarea name="penyebab_perceraian" class="form-textarea" rows="2" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="upload-section">
                            <div class="upload-info">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-check"></i> Akte Perkawinan (PDF/JPG, Max 2MB)</li>
                                    <li><i class="fas fa-check"></i> Putusan Pengadilan (PDF/JPG, Max 2MB)</li>
                            ...
                            <div class="upload-grid">
                                ...
                                <div class="upload-item">
                                    <div class="upload-box" data-upload="file_akte_perkawinan" style="cursor:pointer;">
                                        <div class="upload-icon"><i class="fas fa-file-alt"></i></div>
                                        <div class="upload-text">
                                            <h4>Akte Perkawinan</h4>
                                            <p>Drag & drop atau klik untuk upload</p>
                                            <span class="file-types">PDF, JPG (Max 2MB)</span>
                                        </div>
                                        <input type="file" id="file-akte-perkawinan" name="file_akte_perkawinan" accept=".pdf,.jpg,.jpeg" hidden required>
                                        <span class="file-name"></span>
                                    </div>
                                </div>
                                <div class="upload-item">
                                    <div class="upload-box" data-upload="file_putusan_pengadilan" style="cursor:pointer;">
                                        <div class="upload-icon"><i class="fas fa-gavel"></i></div>
                                        <div class="upload-text">
                                            <h4>Putusan Pengadilan</h4>
                                            <p>Drag & drop atau klik untuk upload</p>
                                            <span class="file-types">PDF, JPG (Max 2MB)</span>
                                        </div>
                                        <input type="file" id="file-putusan-pengadilan" name="file_putusan_pengadilan" accept=".pdf,.jpg,.jpeg" hidden required>
                                        <span class="file-name"></span>
                                    </div>
                                </div>
                                <div class="upload-item">
                ...
                <div class="form-step" id="step-7">
                    <div class="step-content">
                        <div class="success-content">
                            ...
                            <p>Terima kasih telah mengajukan pembuatan Akte Perceraian. Berikut detail pengajuan Anda:</p>
...
function validateCurrentStep() {
    ...
    // Validasi file upload di step 5
    if (currentStep === 5) {
        let uploads = [
            {id: 'file-ktp-suami', label: 'KTP Suami'},
            {id: 'file-ktp-istri', label: 'KTP Istri'},
            {id: 'file-akte-perkawinan', label: 'Akte Perkawinan'},
            {id: 'file-putusan-pengadilan', label: 'Putusan Pengadilan'},
...
document.getElementById('perceraian-form').onsubmit = function(e) {
    e.preventDefault();
    if (!validateCurrentStep()) return;
    submitPerceraianAjax();
};
...
function submitPerceraianAjax() {
    let form = document.getElementById('perceraian-form');
    ...
    fetch('<?= base_url('form/akteperceraian/prosesAkteAjax') ?>', {
        method: 'POST',
        body: formData
    })
    .then(res => res.json())
    .then(res => {
        ...
        if (res.status === 'success') {
            ...
            setTimeout(() => window.location.href = '<?= base_url('form/akteperceraian/riwayat') ?>', 2000);
        } else {
            let err = res.message;
            if (res.errors)
